...
<td valign="middle" height="40" style="font-family: Arial;font-size: 12" ><a style="text-decoration: none" href="produitsAddMarque.jsp"> <img src="http://cdn1.iconfinder.com/data/icons/fatcow/32x32_0520/layout_add.png"></a></td>			</tr>
  ...
  <td><b><p style="font-family: Helvetica">Formulaire d'ajout de produit en base de données</p></b></td>
   </tr>
  </table>
 <br><br>
       <form name="addForm" action="BackOfficeServlet" method="POST">
       <table boder="0" style="font-family: Helvetica;font-size: 12">
       <tr><td><label><b>Nom du produit :</b></td><td> <input type="text" name="name" id="nameInput"></label><br/></td></tr>
		<tr><td><label><b>Prix du produit :</b></td><td> <input type="text" name="price" id="fnameInput"></label><br/></td></tr>
		<tr><td><label><b>Image (chemain) :</b></td><td> <input type="text" name="pic" id="logInput"></label><br/></td></tr>
		<tr><td><label><b>Disponibilité (0 ou 1) :</b></td><td> <input type="text" name="dispo" id="dispoInput"></label><br/></td></tr>
