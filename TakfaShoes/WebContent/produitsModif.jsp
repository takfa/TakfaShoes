     ...
     <tr style="background-color:white;width: 1000px">
      ...
      <td style="text-align: center">
       <form name="addForm"
        ...
        <input border=0 src="http://cdn1.iconfinder.com/data/icons/UII_Icons/24x24/configuration_edit.png" type=image name="submit" Value=submit align="middle" > 
        <input type="hidden" name="action" value="toModif">
       </form>
      </td></tr>
    </div>
